...
plot_k_A = var_ba_df %>%
    ...
    scale_y_log10() +
    labs(x = "k (maximum growth rate)",
         y = "A (interspecific competition)",
         fill = "Species Richness\n(at t = 150)",
         subtitle = "Average Richness over all values of B/A & H/k") +
...
plot_A_BA = var_ba_df %>%
    ...
    scale_x_log10() +
    scale_y_log10() +
    labs(x = "A (interspecific competition)",
         y = "B/A (ratio intra/inter)",
         fill = "Species Richness\n(at t = 150)",
         subtitle = "Average Richness over all values of k & H/k") +
    theme(legend.position = "top")
...
plot_k_BA = var_ba_df %>%
    ...
    labs(x = "k (maximum growth rate)",
         y = "B/A (ratio intra/inter)",
         fill = "Species Richness\n(at t = 150)",
         subtitle = "Average Richness over all values of A & H/k") +
    theme(legend.position = "top")

plot_k_Hk = var_ba_df %>%
    filter(patch %in% paste0("patches", c(1, 13))) %>%
    ggplot(aes(k, H_over_k)) +
    stat_summary_2d(aes(z = species_rich), fun = "mean", geom = "raster") +
    facet_wrap(~patch) +
    scale_fill_viridis_c() +
    labs(x = "k (maximum growth rate)",
         y = "H/k (ratio hierarchical compet/max. growth)",
         fill = "Species Richness\n(at t = 150)",
         subtitle = "Average Richness over all values of A and B/A") +
    theme(legend.position = "top")

plot_A_Hk = var_ba_df %>%
    filter(patch %in% paste0("patches", c(1, 13))) %>%
    ggplot(aes(A, H_over_k)) +
    stat_summary_2d(aes(z = species_rich), fun = "mean", geom = "raster") +
    facet_wrap(~patch) +
    scale_fill_viridis_c() +
    scale_x_log10() +
    labs(x = "A (interspecific competition)",
         y = "H/k (ratio hierarchical compet/max. growth)",
         fill = "Species Richness\n(at t = 150)",
         subtitle = "Average Richness over all values of k and B/A") +
    theme(legend.position = "top")

plot_BA_Hk = var_ba_df %>%
    filter(patch %in% paste0("patches", c(1, 13))) %>%
    ggplot(aes(B_over, H_over_k)) +
    stat_summary_2d(aes(z = species_rich), fun = "mean", geom = "raster") +
    facet_wrap(~patch) +
    scale_fill_viridis_c() +
    scale_x_log10() +
    labs(x = "B/A (ratio intra/inter)",
         y = "H/k (ratio hierarchical compet/max. growth)",
         fill = "Species Richness\n(at t = 150)",
         subtitle = "Average Richness over all values of k and A") +
    theme(legend.position = "top")
...
plot_average_r_squared = function(var_df, x_var, y_var, given_labs = var_labs) {
    ...
    labs(x = var_labs[[x_var]],
         y = var_labs[[y_var]],
         fill = "CWM <-> Env. R^2",
         subtitle = paste0("Average R-squared over all values of ",
