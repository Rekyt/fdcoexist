...
total_runs = 200  # Number of set of traits to test
...
meta_simul = function(seed_number, given_k = k) {
...
lab_compet_env = labeller(
    ...
    env_width     = c(constant  = "Same Filter Strength\nAlong Gradient",
                      varying   = "Increasing Filter Strength\nAlong Gradient"))
