...
run_char = paste0("N = ", total_runs, "; A = ", A, "; B = ", B)
```
...
ggplot(first_simuls_r2, aes(scenario, r.squared)) +
    ...
    labs(subtitle = paste0("R2 of trait2 CWM ~ environment; ", run_char),
         x = "Scenario",
         y = expression("R"^2)) +
...
ggplot(first_simuls_var, aes(scenario, var_value)) +
    ...
    ylim(0, NA) +
    scale_fill_viridis_d("Trait\nCorrelations", labels = lab_cor) +
    labs(subtitle = paste0("Trait Variance across Patches; ", run_char),
         x = "Scenario",
