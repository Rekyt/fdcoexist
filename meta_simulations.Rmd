...
normal_k = 1.15
normal_k_run_char = paste0("N = ", total_runs, "; A = ", A, "; B = ", B, "; k = ",
                        normal_k)
...
# Simulation parameters --------------------------------------------------------
low_k = 1.05
low_k_same_A_run_char = paste0("N = ", total_runs, "; A = ", A, "; B = ", B, "; k = ",
                        normal_k)
...
normal_k = 1.05
high_A = 2e-2
normal_k_same_A_run_char = paste0("N = ", total_runs, "; A = ", high_A,
                                  "; B = ", B, "; k = ",
                                  normal_k)
...
normal_k_high_A_simuls = future_map(seq(total_runs), function(x) {
    ...
    meta_simul(x, given_k = normal_k, given_A = high_A)
}, .progress = FALSE)
tictoc::toc()
```
...
```{r normal_k_paper_figures}
# Simpler Figures ----------------------------------------------------------------------
# Show shape of CWM <-> across situations
plot_normal_k_cwm_env = normal_k_simuls %>%
    bind_rows() %>%
    filter(!(scenario %in% c("R75A25", "R25A75")),
           compet_status %in% "compet") %>%
    ...
    facet_grid(rows = vars(env_width), cols = vars(scenario),
