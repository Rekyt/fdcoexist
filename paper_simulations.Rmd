...
fig_ind_landscape = function(simul_df, simul_label, n_bins = 22,
    ...
    ggplot(aes(patch_optim, trait_value, z = N)) +
...
```{r no_compet_low_cor_abund_env}
plot_no_compet_low_cor_abund_env = fig_abund_env(no_compet_low_cor_df,
                                                 no_compet_low_cor_label)

plot_no_compet_low_cor_abund_env
```

```{r no_compet_low_cor_cwm_env}
plot_no_compet_low_cor_cwm_env = fig_cwm_env(no_compet_low_cor_df,
                                             no_compet_low_cor_label)

plot_no_compet_low_cor_cwm_env
```

```{r no_compet_low_cor_cwm_env_abund}
plot_no_compet_low_cor_cwm_env_abund = fig_cwm_env_abund(no_compet_low_cor_df,
                                                         no_compet_low_cor_label,
                                                         given_trans = "log10")

plot_no_compet_low_cor_cwm_env_abund
```
...
```{r no_compet_high_cor_abund_env}
plot_no_compet_high_cor_abund_env = fig_abund_env(no_compet_high_cor_df,
                                                  no_compet_high_cor_label)

plot_no_compet_high_cor_abund_env
```

```{r no_compet_high_cor_cwm_env}
plot_no_compet_high_cor_cwm_env = fig_cwm_env(no_compet_high_cor_df,
                                              no_compet_high_cor_label)
plot_no_compet_high_cor_cwm_env
```


```{r no_compet_high_cor_cwm_env_abund}
plot_no_compet_high_cor_cwm_env_abund = fig_cwm_env_abund(no_compet_high_cor_df,
                                                          no_compet_high_cor_label,
                                                          given_trans = "log10")

plot_no_compet_high_cor_cwm_env_abund
```
...
```{r compet_no_cor_abund_env}
plot_compet_no_cor_abund_env = fig_abund_env(compet_no_cor_df,
                                             compet_no_cor_label)

plot_compet_no_cor_abund_env
```

```{r compet_no_cor_cwm_env}
plot_compet_no_cor_cwm_env = fig_cwm_env(compet_no_cor_df,
                                         compet_no_cor_label)

plot_compet_no_cor_cwm_env
```

```{r compet_no_cor_cwm_env_abund}
plot_compet_no_cor_cwm_env_abund = fig_cwm_env_abund(compet_no_cor_df,
                                                     compet_no_cor_label,
                                                     given_trans = "identity")
plot_compet_no_cor_cwm_env_abund
```
...
```{r compet_low_cor_abund_env}
plot_compet_low_cor_abund_env = fig_abund_env(compet_low_cor_df,
                                              compet_low_cor_label)

plot_compet_low_cor_abund_env
```

```{r compet_low_cor_cwm_env}
plot_compet_low_cor_cwm_env = fig_cwm_env(compet_low_cor_df,
                                          compet_low_cor_label)

plot_compet_low_cor_cwm_env
```


```{r compet_low_cor_cwm_env_abund}
plot_compet_low_cor_cwm_env_abund = fig_cwm_env_abund(compet_low_cor_df,
                                                      compet_low_cor_label,
                                                      given_trans = "identity")

plot_compet_low_cor_cwm_env_abund
```
...
```{r compet_high_cor_abund_env}
plot_compet_high_cor_abund_env = fig_abund_env(compet_high_cor_df,
                                               compet_high_cor_label)

plot_compet_high_cor_abund_env
```

```{r compet_high_cor_cwm_env}
plot_compet_high_cor_cwm_env = fig_cwm_env(compet_high_cor_df,
                                           compet_high_cor_label)

plot_compet_high_cor_cwm_env
```


```{r compet_high_cor_cwm_env_abund}
plot_compet_high_cor_cwm_env_abund = fig_cwm_env_abund(compet_high_cor_df,
                                                       compet_high_cor_label,
                                                       given_trans = "identity")

plot_compet_high_cor_cwm_env_abund
```
