...
lalaland = ggplot(all_land, aes(compet_dist, optim_dist)) +
...
plot_laughlin = ggplot(all_land, aes(optim_env, patch_optim)) +
    stat_summary_2d(aes(z = N)) +
    facet_wrap(~simulation_type, labeller = c(R2_A8 = "20% Growth\n80% Competiton",
                                              R5_A5 = "50% Growth\n50% Competiton",
                                              R8_A2 = "80% Growth\n20% Competiton") %>%
                   as_labeller()) +
    scale_fill_viridis_c(trans = "log10") +
    labs(x    = "Species Optimum",
