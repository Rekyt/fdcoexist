...
landscape_df = function(multiple_traits_scenario, trait_types_row) {
    
    growth_traits = names(trait_types_row[trait_types_row %in% c("R", "RA")])
    compet_traits = names(trait_types_row[trait_types_row %in% c("A", "RA")])
...
### Moderately correlated traits (4 traits, various scenarios)
...
trait_types = t(data.frame(R8_A2 = c(rep("R", round(0.8*n_traits)),
                                     rep("A", n_traits - round(0.8*n_traits))),
                           R5_A5 = c(rep("R", round(0.5*n_traits)),
                                     rep("A", n_traits - round(0.5*n_traits))),
                           R2_A8 = c(rep("R", round(0.2*n_traits)),
...
### Moderately correlated traits (3 traits)
...
# Number of trait influencing growth or competition
trait_types = c(trait1 = "R", trait2 = "RA", trait3 = "A")
