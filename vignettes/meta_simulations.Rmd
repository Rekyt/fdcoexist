...
var_scenars_perf = future_map2_dfr(
    flatten(var_scenars), flatten(rep(rep(used_trait_list, 27, each = TRUE), 8)),
    ~extract_performances_from_simul(.x, .y, TRUE), .progress = TRUE)
```
