...
plot_var_scenars_cwm = function(var_scenars_cwm) {
    given_n_seed    = length(unique(var_scenars_cwm$seed))
    given_trait_cor = unique(var_scenars_cwm$trait_cor)
    given_k         = unique(var_scenars_cwm$k)
    given_h_fun     = unique(var_scenars_cwm$h_fun)
    given_A         = unique(var_scenars_cwm$A)
    given_B_over_A  = unique(var_scenars_cwm$B_over_A)
    given_H         = unique(var_scenars_cwm$H)
