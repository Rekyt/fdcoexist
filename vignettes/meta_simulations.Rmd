...
set.seed(1)
big_trait_list = list(
    uncor   = generate_cor_traits(max_value, big_species, n_traits - 1,
...
# Actual simulation
tictoc::tic()
big_species_simul = list(seed     = seq(1:5),
                         k        = fixed_k,
                         A        = fixed_A,
                         B_over_A = fixed_B_over_A,
                         H        = fixed_H) %>%
