...
var_scenars = meta_simul_A_B_k_and_H(seed_number    = 1,
                                     given_k        = fixed_k,
                                     given_A        = fixed_A,
                                     given_B_over_A = fixed_B_over_A,
                                     given_H        = fixed_H,
...
var_scenars_df = tidy_simulation_list(var_scenars, used_traits, scenar_list,
...
var_scenars_cwm = var_scenars_df %>%
    group_by(scenario, R_scenar, A_scenar, H_scenar, patch) %>%
